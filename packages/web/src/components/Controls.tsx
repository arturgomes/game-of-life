...
export function Controls() {
  ...
  return (
    <div>
      ...
      <div className="flex flex-row gap-2 space-y-4 align-top">
        {/* Board Setup Section */}
        <Card>
          <Card.Header>
          ...
          <Card.Body>
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label htmlFor="rows" className="block mb-1 text-sm font-medium text-gray-700">
                    Rows
                  </label>
                  <Input
                    id="rows"
                ...
                <div>
                  <label htmlFor="cols" className="block mb-1 text-sm font-medium text-gray-700">
                    Columns
                  </label>
                  <Input
                    id="cols"
